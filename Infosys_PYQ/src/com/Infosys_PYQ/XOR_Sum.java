...
so their friend Resli decided to make up a problem that would enjoy both of them. 
Resil wrote down an array A of length N, an integer K and he defined a new function called  Xor- sum as follows 
...
public class XOR_Sum {
	...
	public static void main(String[] args) {
		...
		System.out.println(xor_sum(arr, k)); // 14

	}

	private static int xor_sum(int[] arr, int k) {

		int xorSum = Integer.MIN_VALUE;
