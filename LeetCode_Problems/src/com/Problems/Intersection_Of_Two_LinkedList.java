...
different node references. In other words, they point to two different locations in memory, while the nodes with value 8 in A and 
...
From the head of A, it reads as [1,9,1,2,4]. From the head of B, it reads as [3,2,4]. There are 3 nodes before the intersected 
...
public class Intersection_Of_Two_LinkedList {
	...
	public static void main(String[] args) {
		...
		/*
		 * Create the following structure: listA: 4 -> 1 \ -> 8 -> 4 -> 5 listB: 5 -> 6
		 * -> 1 /
		 */
